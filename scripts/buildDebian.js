...
async function afterPackageBuilt(path, arch) {
  var installerOptions = {
    artifactName: 'demin-${version}-${arch}.deb',
    packageName: 'demin',
    ...
    description: 'Demin is a DNN browser with decentralized naming and certificate verification.',
    synopsis: 'A DNN-enabled web browser with decentralized domain naming, certificate verification from Nostr events, and built-in privacy protection.',
    depends: [
      'libsecret-1-0',
      'libasound2',
      'libc6',
